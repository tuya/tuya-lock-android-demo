...
public class PasswordUpdateActivity extends AppCompatActivity {
    ...
    private TempPassword mPasswordData;

    public static void startActivity(Context context, TempPassword bean,
                                     String devId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordData = JSONObject.parseObject(getIntent().getStringExtra(Constant.PASSWORD_DATA), TempPassword.class);
