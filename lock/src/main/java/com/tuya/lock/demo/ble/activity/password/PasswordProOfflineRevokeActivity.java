...
import com.tuya.smart.sdk.optimus.lock.bean.ble.OfflinePasswordRevokeRequest;

public class PasswordProOfflineRevokeActivity extends AppCompatActivity {
    ...
    private void getProSingleRevokeOfflinePassword() {
        ...
        revokeRequest.setName(name);
        revokeRequest.setPasswordId(unlockBindingId);
        tuyaLockDevice.getProSingleRevokeOfflinePassword(revokeRequest, new ITuyaResultCallback<String>() {
            @Override
