...
public class WifiDeviceDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tuyaDevice = TuyaHomeSdk.newDeviceInstance(mDevId);
        tuyaDevice.registerDevListener(deviceListener);
    ...
    private void remoteUnlock(boolean unlock) {
        wifiLock.replyRemoteUnlock(unlock, new ITuyaResultCallback<Boolean>() {
            @Override
