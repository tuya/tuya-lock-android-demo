...
import com.tuya.smart.sdk.optimus.lock.bean.ble.OpModeRemoveRequest;
import com.tuya.smart.sdk.optimus.lock.bean.ble.UnlockDetail;
...
public class OpModeListActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        DeviceBean deviceBean = TuyaOSDevice.getDeviceBean(deviceId);
    ...
    private void getListData() {
        zigBeeLock.getMemberOpmodeList(memberInfo.getUserId(), new ITuyaResultCallback<ArrayList<OpModeBean>>() {
            @Override
