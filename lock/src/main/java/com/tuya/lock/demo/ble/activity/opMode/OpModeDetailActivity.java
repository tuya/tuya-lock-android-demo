...
import com.tuya.smart.sdk.optimus.lock.bean.ble.NotifyInfoBean;
import com.tuya.smart.sdk.optimus.lock.bean.ble.OpModeDetailBean;
import com.tuya.smart.sdk.optimus.lock.bean.ble.OpModeRequest;
...
public class OpModeDetailActivity extends AppCompatActivity {
    ...
    public void initUi() {
        ...
        if (dpCode.equals(TuyaUnlockType.PASSWORD)) {
    ...
    private void validateOpModePassword() {
        if (TextUtils.equals(dpCode, TuyaUnlockType.PASSWORD)) {
            tuyaLockDevice.validateOpModePassword(request.getPassword(), new ITuyaResultCallback<String>() {
                @Override
    ...
    public void onBackPressed() {
        //展示指纹录入的提示
        if (dpCode.equals(TuyaUnlockType.FINGERPRINT) && isAddMode) {
