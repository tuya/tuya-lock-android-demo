...
import com.tuya.smart.sdk.optimus.lock.bean.ble.OnlinePasswordDeleteRequest;
...
public class PasswordProListActivity extends AppCompatActivity {
    ...
    private void deletePasscode(ProTempPasswordItem passwordItem, int position) {
        ...
        tuyaLockDevice.deleteProOnlinePassword(deleteRequest, new ITuyaResultCallback<String>() {
            @Override
