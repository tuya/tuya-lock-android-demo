...
import com.tuya.smart.optimus.lock.api.zigbee.request.OpModeAddRequest;
import com.tuya.smart.optimus.lock.api.zigbee.response.MemberInfoBean;
import com.tuya.smart.optimus.lock.api.zigbee.response.OpModeAddBean;
import com.tuya.smart.optimus.lock.api.zigbee.response.OpModeBean;
import com.tuya.smart.optimus.lock.api.zigbee.status.ZigbeeOpModeStage;
...
public class OpModeDetailActivity extends AppCompatActivity {
    ...
    private void addUnlockMode() {
        isAddMode = true;
        if (!tyabitmqxx && dpCode.equals(TuyaUnlockType.PASSWORD)) {
