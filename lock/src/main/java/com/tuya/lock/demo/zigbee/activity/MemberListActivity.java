...
import com.tuya.smart.optimus.lock.api.zigbee.response.UnAllocOpModeBean;
...
public class MemberListActivity extends AppCompatActivity {
    ...
    public static void startActivity(Context context, String devId) {
        ...
        //设备id
        intent.putExtra(com.tuya.lock.demo.ble.constant.Constant.DEVICE_ID, devId);
    ...
    private void getLockUser() {
        zigBeeLock.getMemberList(new ITuyaDataCallback<ArrayList<MemberInfoBean>>() {
            @Override
