...
import com.tuya.lock.demo.ble.activity.member.MemberSelectListActivity;
...
import com.tuya.smart.sdk.optimus.lock.bean.ble.AllocOpModeBean;
import com.tuya.smart.sdk.optimus.lock.bean.ble.UnlockInfoBean;
