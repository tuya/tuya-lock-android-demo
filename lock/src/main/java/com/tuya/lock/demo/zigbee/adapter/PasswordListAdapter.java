...
import com.tuya.lock.demo.zigbee.utils.DialogPasswordUtils;
...
public class PasswordListAdapter extends RecyclerView.Adapter<PasswordListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String count = bean.getOneTime() == 1 ? "[一次性] " : "[周期] ";
        ...
        String passwordStr = "明文密码:" + bean.getPassword();
    ...
    private void showDialog(Context context, PasswordBean.DataBean bean, int position) {
        DialogPasswordUtils.show(context, bean, new DialogPasswordUtils.Callback() {
            @Override
