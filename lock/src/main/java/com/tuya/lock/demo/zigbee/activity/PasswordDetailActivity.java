...
import com.tuya.smart.optimus.lock.api.zigbee.request.ScheduleBean;
import com.tuya.smart.optimus.lock.api.zigbee.response.PasswordBean;
import com.tuya.smart.optimus.sdk.TuyaOptimusSdk;
import com.tuya.smart.sdk.optimus.lock.utils.ZigbeeLockUtils;
...
public class PasswordDetailActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private void setScheduleEffectiveTime() {
        ...
        if (scheduleBean.getEffectiveTime() == 0) {
            ...
            password_schedule_effective_time_hour.setText("00");
        } else {
        ...
        if (scheduleBean.getEffectiveTime() == 0) {
            ...
            password_schedule_effective_time_minute.setText("00");
        } else {
    ...
    private void setScheduleInvalidTime() {
        ...
        if (scheduleBean.getInvalidTime() == 0) {
            if (mFrom == 0) {
                ...
                password_schedule_invalid_time_hour.setText("00");
            }
        } else {
        ...
        if (scheduleBean.getInvalidTime() == 0) {
            if (mFrom == 0) {
                ...
                password_schedule_invalid_time_minute.setText("00");
            }
        } else {
