...
public class PasswordProOfflineAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (type) {
            ...
            case Constant.TYPE_MULTIPLE:
                ...
                toolbar.setTitle(getResources().getString(R.string.offline_password));
                break;
            case Constant.TYPE_CLEAR_ALL:
                pwdType = OfflineTempPasswordType.CLEAR_ALL;
                toolbar.setTitle(getResources().getString(R.string.passwords_clear));
                break;
        }
    ...
    private void getProOfflinePassword() {
