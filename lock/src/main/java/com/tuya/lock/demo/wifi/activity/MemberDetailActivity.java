...
public class MemberDetailActivity extends AppCompatActivity {
    ...
    private void addLockUser() {
        wifiLock.addLockUser(userBean.userName, null, unlockRelations, new ITuyaResultCallback<String>() {
            @Override
    ...
    private void upDateLockUser() {
        if (isUnlockEdit) {
            wifiLock.updateFamilyUserUnlockMode(userBean.userId, unlockRelations, new ITuyaResultCallback<Boolean>() {
                @Override
        ...
        wifiLock.updateLockUser(userBean.userId, userBean.userName, null, unlockRelations, new ITuyaResultCallback<Boolean>() {
            @Override
            public void onSuccess(Boolean result) {
                Log.i(Constant.TAG, "update lock user success");
                Toast.makeText(getApplicationContext(), "update lock user success", Toast.LENGTH_SHORT).show();
