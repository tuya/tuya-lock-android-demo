...
public class PasswordSingleRevokeListAdapter extends RecyclerView.Adapter<PasswordSingleRevokeListAdapter.ViewHolder> {
    ...
    private IResultCallback<OfflineTempPassword> callback;
    ...
    public void delete(IResultCallback<OfflineTempPassword> callback) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        OfflineTempPassword bean = (OfflineTempPassword) data.get(position);
