...
public class PasswordProOnlineDetailActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password_effective_time.setText(Utils.getDateDay(mPasswordData.getEffectiveTime()));
        ...
        password_invalid_time.setText(Utils.getDateDay(mPasswordData.getInvalidTime()));
    ...
    private void createPassword() {
        ...
        if (mFrom == 0) {
            tuyaLockDevice.getProCustomOnlinePassword(passwordRequest, new ITuyaResultCallback<String>() {
                @Override
            ...
            tuyaLockDevice.updateProOnlinePassword(passwordRequest, new ITuyaResultCallback<String>() {
                @Override
                public void onSuccess(String result) {
                    Toast.makeText(getApplicationContext(), "onSuccess", Toast.LENGTH_SHORT).show();
                    finish();
