...
public class PasswordOldOfflineAdd2Activity extends AppCompatActivity {
    ...
    private void getProSingleRevokeOfflinePassword() {
        pwdId = getIntent().getStringExtra("pwdId");

        tuyaLockDevice.getSingleRevokeOfflinePassword(pwdId, new ITuyaResultCallback<String>() {
            @Override
