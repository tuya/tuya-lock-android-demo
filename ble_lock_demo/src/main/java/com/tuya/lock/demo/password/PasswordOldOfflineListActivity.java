...
import com.tuya.lock.demo.adapter.PasswordOldOfflineListAdapter;
import com.tuya.lock.demo.constant.Constant;
import com.tuya.smart.home.sdk.callback.ITuyaResultCallback;
import com.tuya.smart.optimus.lock.api.ITuyaBleLockV2;
import com.tuya.smart.optimus.lock.api.ITuyaLockManager;
import com.tuya.smart.optimus.lock.api.bean.OfflineTempPasswordItem;
import com.tuya.smart.optimus.lock.api.enums.OfflineTempPasswordStatus;
...
public class PasswordOldOfflineListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.password_offline_inquire).setOnClickListener(v -> getOfflineTempPasswordList());
    }
    ...
    private void getOfflineTempPasswordList() {
        tuyaLockDevice.getOfflinePasswordList(selectType, 0, 10, selectStatus, new ITuyaResultCallback<ArrayList<OfflineTempPasswordItem>>() {
            @Override
