...
import com.tuya.lock.demo.password.PasswordOldOfflineAdd2Activity;
...
public class PasswordOldOfflineListAdapter extends RecyclerView.Adapter<PasswordOldOfflineListAdapter.ViewHolder> {
    ...
    private IResultCallback<OfflineTempPasswordItem> callback;
    ...
    public void deleteUser(IResultCallback<OfflineTempPasswordItem> callback) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        OfflineTempPasswordItem bean = (OfflineTempPasswordItem) data.get(position);
        ...
        holder.button_detail.setOnClickListener(v -> {
            Intent intent = new Intent(v.getContext(), PasswordOldOfflineAdd2Activity.class);
